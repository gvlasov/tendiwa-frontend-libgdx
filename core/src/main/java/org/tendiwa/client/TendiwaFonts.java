 ...
 */
public final BitmapFont default14NonFlipped = new FreeTypeFontGenerator(Gdx.files.internal("assets/DejaVuSansMono.ttf"))
...
public final BitmapFont default14Flipped = new FreeTypeFontGenerator(Gdx.files.internal("assets/DejaVuSansMono.ttf"))
	.generateFont(14, "1234567890qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM_.,-'\"", true);
public final BitmapFont default8NonFlipped = new FreeTypeFontGenerator(Gdx.files.internal("assets/DejaVuSansMono.ttf"))
...
public final BitmapFont default20Flipped = new FreeTypeFontGenerator(Gdx.files.internal("assets/DejaVuSansMono.ttf"))
